...
//        createTable("example1");
//        list("example1");
//         insertData("example1");
//         QueryAll("example1");
//         QueryByCondition1("example1");
         QueryByCondition2("example1");
        //QueryByCondition3("example1");
        //deleteRow("example1","abcdef");
//        deleteByCondition("example1","abcdef");
    }
